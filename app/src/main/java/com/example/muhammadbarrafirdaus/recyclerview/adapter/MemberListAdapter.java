package com.example.muhammadbarrafirdaus.recyclerview.adapter;
...
public class MemberListAdapter
        extends RecyclerView.Adapter<MemberListAdapter.MemberViewHolder> {
    ...
    private void add(Member item) {
        memberList.add(item);
        notifyItemChanged(memberList.size() - 1);
    }
    ...
    static class MemberViewHolder extends RecyclerView.ViewHolder {
        ...
        public MemberViewHolder(View itemView) {
            ...
            memberName = (TextView) itemView.findViewById(R.id.nama);
            memberTeam = (TextView) itemView.findViewById(R.id.wallpaper);
        }
    }
}
